...
$birth_sql = "SELECT b.id, 'Birth' as cert_type, b.certificate_number, b.child_fullname as subject_name, b.status, b.fee_amount, b.payment_status, b.created_at, u.fullname as staff_name 
...
$death_sql = "SELECT d.id, 'Death' as cert_type, d.certificate_number, d.deceased_fullname as subject_name, d.status, d.fee_amount, d.payment_status, d.created_at, u.fullname as staff_name 
...
if (isset($_GET['export']) && $_GET['export'] === 'csv') {
    ...
    header('Content-Disposition: attachment; filename=Civil_Registration_Report_' . date('Ymd_His') . '.csv');
    $output = fopen('php://output', 'w');
    
    fputcsv($output, ['Certificate Number', 'Type', 'Subject Name', 'Status', 'Fee (ZMW)', 'Payment Status', 'Registered By', 'Date Registered']);
...
<head>
    ...
    <title>System Reports - <?php echo SITE_NAME; ?></title>
    ...
    <div class="dashboard-wrapper">
        ...
        <main class="main-content">
            <div class="content-body">
                <h1 style="color: #2c3e50; margin-bottom: 0.5rem;"><i class="fas fa-file-contract"></i> Registry Reports</h1>
                <p style="color: #7f8c8d; margin-bottom: 2rem;" class="no-print">Generate, filter, print, and export certificate registration records.</p>
                ...
                <div style="overflow-x: auto;">
                    <table>
                        ...
                        <tbody>
                            ...
                            <?php else: ?>
                                <tr>
                                    <td colspan="8" style="text-align: center;">No registry records match the selected filters.</td>
                                </tr>
                            <?php endif; ?>
                        </tbody>
                    </table>
            ...
            <footer style="margin-left: -3rem; margin-right: -3rem; margin-bottom: -2rem;">
                <p>&copy; <?php echo date('Y'); ?> <?php echo SITE_NAME; ?>. Registry Reports | Designed by Natasha Banda</p>
            </footer>
        </main>
    </div>
