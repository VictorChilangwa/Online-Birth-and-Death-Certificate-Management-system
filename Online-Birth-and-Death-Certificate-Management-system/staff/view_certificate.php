...
$verify_url = "$protocol://$host/Online-Birth-and-Death-Certificate-Management-system/view_official_certificate.php?nid=" . urlencode($data['third_party_nid']) . "&code=" . urlencode($data['certificate_number']);
...
<head>
    ...
    <style>
        ...
        * {
        ...
        .grid-row:first-child .grid-section-header {
            border-top: none;
        }
